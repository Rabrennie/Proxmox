...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/Rabrennie/Proxmox/main/ct/create_lxc.sh)" || exit
...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/Rabrennie/Proxmox/main/setup/paperlessngx-install.sh)" || exit
